...
export default function ExamplePage() {
  ...
  return (
    <div className="space-y-4 my-4 sm:space-y-6 lg:space-y-8 w-full max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
      {/* Header */}
        ...
        <CardContent className="p-3 sm:p-4 lg:p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 rounded-lg p-3 sm:p-4 space-y-3">
                <div className="flex justify-between items-center">
                  <span className="font-medium text-gray-700 text-sm sm:text-base">Roll Width:</span>
                  <span className="text-gray-900 text-sm sm:text-base">1000 mm</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-medium text-gray-700 text-sm sm:text-base">
                    Material Type:
                  </span>
                  <span className="text-gray-900 text-sm sm:text-base">Paper</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-medium text-gray-700 text-sm sm:text-base">
                    Optimization Goal:
                  </span>
                  <span className="text-gray-900 text-sm sm:text-base">Minimize Wastage</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-medium text-gray-700 text-sm sm:text-base">
                    Total Items:
                  </span>
                  <span className="text-gray-900 text-sm sm:text-base">5 different sizes</span>
                </div>
              </div>
            </div>
                ...
                <table className="w-full text-xs sm:text-sm">
                  <thead>
                    <tr className="bg-gray-50">
                      <th className="text-left p-2 sm:p-3 font-medium text-gray-700">
                        Size (mm)
                      </th>
                      <th className="text-left p-2 sm:p-3 font-medium text-gray-700">
                        NOR
                  ...
                  <tbody className="divide-y divide-gray-200">
                    <tr>
                      <td className="p-2 sm:p-3 text-gray-900">250</td>
                      <td className="p-2 sm:p-3 text-gray-900">2</td>
                      <td className="p-2 sm:p-3 text-gray-900">150</td>
                    </tr>
                    <tr>
                      <td className="p-2 sm:p-3 text-gray-900">180</td>
                      <td className="p-2 sm:p-3 text-gray-900">5</td>
                      <td className="p-2 sm:p-3 text-gray-900">270</td>
                    </tr>
                    <tr>
                      <td className="p-2 sm:p-3 text-gray-900">120</td>
                      <td className="p-2 sm:p-3 text-gray-900">1</td>
                      <td className="p-2 sm:p-3 text-gray-900">72</td>
                    </tr>
                    <tr>
                      <td className="p-2 sm:p-3 text-gray-900">300</td>
                      <td className="p-2 sm:p-3 text-gray-900">1</td>
                      <td className="p-2 sm:p-3 text-gray-900">180</td>
                    </tr>
                    <tr>
                      <td className="p-2 sm:p-3 text-gray-900">200</td>
                      <td className="p-2 sm:p-3 text-gray-900">4</td>
                      <td className="p-2 sm:p-3 text-gray-900">480</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <div className="mt-4 sm:mt-6 flex justify-center">
            ...
            >
              ...
              <span className="hidden sm:inline">Download Example Input (Excel)</span>
              <span className="sm:hidden">Download Example</span>
            </Button>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="flex justify-center py-2 sm:py-4">
        <div className="flex items-center space-x-2 sm:space-x-4">
          ...
          <ArrowRightIcon className="h-5 w-5 sm:h-6 sm:w-6 text-gray-400" />
          <div className="h-px bg-gray-300 w-8 sm:w-16"></div>
        </div>
      </div>
      ...
      <Card className="shadow-lg w-full">
        <CardHeader className="bg-green-50 py-2 sm:py-3 lg:py-4 flex items-center px-4 sm:px-6">
          <CardTitle className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-900">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-4">
                <div className="bg-blue-50 rounded-lg p-3 sm:p-4 text-center">
                  <div className="text-lg sm:text-2xl font-bold text-blue-600">92.30%</div>
                ...
                <div className="bg-green-50 rounded-lg p-3 sm:p-4 text-center">
                  ...
                  <div className="text-xs sm:text-sm text-gray-600">Rolls Used</div>
                </div>
                <div className="bg-red-50 rounded-lg p-3 sm:p-4 text-center">
                  <div className="text-lg sm:text-2xl font-bold text-red-600">180 mm</div>
                  <div className="text-xs sm:text-sm text-gray-600">Total Wastage</div>
                </div>
                <div className="bg-purple-50 rounded-lg p-3 sm:p-4 text-center">
                  <div className="text-lg sm:text-2xl font-bold text-purple-600">6</div>
                  <div className="text-xs sm:text-sm text-gray-600">Cutter Changes</div>
                </div>
              </div>
