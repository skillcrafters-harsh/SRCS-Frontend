  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-lg text-gray-600">See how our optimization system works with real-world data examples</p>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                ...
                <div className="flex justify-between">
                  <span className="font-medium text-gray-700">Optimization Goal:</span>
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-gray-900">Cut Requirements</h3>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-gray-50">
                      <th className="text-left p-3 font-medium text-gray-700">Size (mm)</th>
                      <th className="text-left p-3 font-medium text-gray-700">NOR</th>
      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="p-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-gray-900">Cutting Plan Preview</h3>
              <div className="space-y-3">
                <div className="bg-white border rounded-lg p-3">
                  ...
                  <div className="flex space-x-1 h-6">
                    <div className="bg-blue-400 rounded flex-1" style={{ maxWidth: "25%" }}></div>
                    <div className="bg-green-400 rounded flex-1" style={{ maxWidth: "18%" }}></div>
                    <div className="bg-purple-400 rounded flex-1" style={{ maxWidth: "30%" }}></div>
                    <div className="bg-orange-400 rounded flex-1" style={{ maxWidth: "25%" }}></div>
                    <div className="bg-gray-200 rounded" style={{ width: "2%" }}></div>
                  </div>
                  <div className="text-xs text-gray-500 mt-1">250×2, 180×3, 120×1</div>
                </div>
                ...
                <div className="bg-white border rounded-lg p-3">
                  ...
                  <div className="flex space-x-1 h-6">
                    <div className="bg-red-400 rounded flex-1" style={{ maxWidth: "30%" }}></div>
                    <div className="bg-yellow-400 rounded flex-1" style={{ maxWidth: "20%" }}></div>
                    <div className="bg-indigo-400 rounded flex-1" style={{ maxWidth: "40%" }}></div>
                    <div className="bg-gray-200 rounded" style={{ width: "5%" }}></div>
                  </div>
                  <div className="text-xs text-gray-500 mt-1">300×1, 200×2, 180×2</div>
                </div>

                <div className="bg-white border rounded-lg p-3">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-sm font-medium text-gray-700">Roll 3</span>
                    <span className="text-xs text-gray-500">Wastage: 30mm</span>
                  </div>
                  <div className="flex space-x-1 h-6">
                    <div className="bg-pink-400 rounded flex-1" style={{ maxWidth: "40%" }}></div>
                    <div className="bg-cyan-400 rounded flex-1" style={{ maxWidth: "25%" }}></div>
                    <div className="bg-lime-400 rounded flex-1" style={{ maxWidth: "32%" }}></div>
                    <div className="bg-gray-200 rounded" style={{ width: "3%" }}></div>
                  </div>
                  <div className="text-xs text-gray-500 mt-1">200×2, 250×1, 180×2</div>
                </div>
              </div>

              <div className="text-xs text-gray-500 mt-4">
                * Colors represent different cut sizes. Gray areas indicate wastage.
              </div>
            </div>
          </div>
        </CardContent>
