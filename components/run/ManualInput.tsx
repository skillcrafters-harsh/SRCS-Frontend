        ...
        try {
          ...
          if (result.status) {
            ...
            setState({
              ...
              metrics: {
                utilizedPercent: 85, // Calculate from actual data
                wastePercent: 15,
  ...
  return (
    <div className="space-y-3 sm:space-y-4 lg:space-y-6 animate-fade-in">
      ...
      <Card className="shadow-lg border-blue-200 bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
        <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-blue-100 py-3 px-3 sm:px-4 md:px-6">
          <CardTitle className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold">
            1. Enter Your Roll Details
          </CardTitle>
          <p className="text-xs sm:text-sm md:text-base !mt-0">
            Begin by providing the key inputs for your optimization run.
          </p>
        </CardHeader>
        <CardContent className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 p-3 sm:p-4 md:p-6 border-b border-blue-100 pt-3">
          <div className="space-y-1.5 sm:space-y-2">
            ...
            <Input
              ...
              className="border-2 border-gray-300 focus:border-blue-600 focus:outline-none hover:border-blue-500 hover:shadow-lg hover:scale-[1.02] transition-all duration-300 hover:bg-blue-50/30 bg-white text-gray-900 font-medium"
            />
          </div>
          <div className="space-y-1.5 sm:space-y-2">
            <Label
        ...
        {/* Roll Specifications */}
        <div className="flex flex-row sm:flex-row items-start sm:items-center justify-between bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-blue-100 py-3 px-3 sm:px-4 md:px-6 gap-3 sm:gap-2 md:gap-0 items-center">
          ...
          <div className="flex flex-row gap-2  sm:w-auto justify-end sm:justify-start">
            <div>
              <Button
        ...
        <CardContent className="!p-2 sm:p-4 space-y-3 md:p-6">
          {/* Desktop Table View */}
                  ...
                  >
                    <td className="p-3">
                      <Input
                        ...
                        className="min-w-[200px] border-gray-300 hover:shadow-lg hover:scale-[1.02] transition-all duration-300 hover:bg-blue-50/30 bg-white text-gray-900 font-medium border-gray-300 focus:border-blue-600"
                      />
                    </td>
                    {optionalFields.dia && (
                      <td className="p-3">
                    ...
                    {optionalFields.bf && (
                      <td className="p-3">
                        <Input
                          ...
                          className="min-w-[200px] border-2 border-gray-300 focus:border-blue-600 focus:outline-none hover:border-blue-500 hover:shadow-lg hover:scale-[1.02] transition-all duration-300 hover:bg-blue-50/30 bg-white text-gray-900 font-medium"
                        />
                      </td>
                    )}
                    {optionalFields.gsm && (
...
{/* {{ ... }} */}
                    ...
                    {optionalFields.quality && (
                      <td className="p-3">
                        <Input
                          ...
                          className="min-w-[120px] border-2 border-gray-300 focus:border-blue-600 focus:outline-none hover:border-blue-500 hover:shadow-lg hover:scale-[1.02] transition-all duration-300 hover:bg-blue-50/30 bg-white text-gray-900 font-medium"
                        />
                      </td>
                    )}
                    <td className="p-3">
                    ...
                    <td className="p-3">
                      ...
                      >
                        <SelectTrigger className="min-w-[120px] border-2 border-gray-300 focus:border-blue-600 focus:outline-none hover:border-blue-500 hover:shadow-lg hover:scale-[1.02] transition-all duration-300 hover:bg-blue-50/30 bg-white text-gray-900 font-medium">
                ...
                <div className="grid grid-cols-1 gap-3">
                  <div>
                    ...
                    <Input
                      ...
                      className="w-full  border-gray-300  bg-white text-gray-900 font-medium border-gray-300 focus:border-blue-600"
                    />
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <Input
                        ...
                        className=" border-gray-300 focus:border-blue-600 focus:ring-2 focus:ring-blue-200 hover:border-blue-500 bg-white text-gray-900 font-medium"
                      />
                    </div>
                    <div>
                      <Label className="text-xs font-medium text-gray-700">
        ...
        <div className="flex justify-center pt-1">
          <Button
            ...
            size="sm"
            className="sm:w-auto cursor-pointer mb-3 px-3 sm:px-6 md:px-8 py-2 sm:py-3 md:py-4 text-sm sm:text-base md:text-lg font-medium sm:font-semibold bg-gradient-to-r from-blue-400 to-blue-400 hover:from-blue-700 hover:to-blue-800 text-white hover:scale-105 transition-all duration-300 shadow-xl border-0"
          >
            {isOptimizing ? (
              <>
